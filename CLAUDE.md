...
## Purpose
Launcher and deployment system for empathic voice interfaces. Streamlines setup and deployment of voice-enabled applications across multiple platforms.
...
- `components/`: Project specific files
